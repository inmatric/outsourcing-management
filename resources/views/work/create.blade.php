...
<div class="max-w-xl mx-auto mt-10 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
    ...
    <form action="{{ route('work.store') }}" method="POST">
        ...
        <div class="mb-6">
         ...
         <input type="text" id="task_details" name="task_details" value="{{ old('task_details') }}"
          class="block w-full h-32 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base 
          focus:ring-blue-500 focus:border-blue-500 
          dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
          dark:focus:ring-blue-500 dark:focus:border-blue-500 px-4">
        </div>
