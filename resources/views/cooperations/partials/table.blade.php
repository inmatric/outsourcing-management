...
<tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
    ...
    <td class="py-4 px-6 text-sm text-gray-900 dark:text-white">
        @foreach(explode(',', $cooperation->cooperation_type) as $type)
    ...
    <td class="py-4 px-6 text-center">
        <a href="{{ route('cooperations.edit', $cooperation->id) }}" class="text-yellow-600 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-300 mr-3">
            Edit
        </a>
        <button 
