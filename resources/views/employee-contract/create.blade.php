...
<div class="">
    ...
    {{-- heading --}}
    <h2 class="text-4xl font-bold dark:text-white my-6">Add Employee Contract</h2>
    ...
    <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg p-6">
        ...
        <form class="max-w-4xl mx-auto">
            ...
            <div class="mb-5">
                <label for="working-hours" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Working Hours
                </label>
                <input type="number" id="working-hours"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required />
            </div>
            <div class="mb-5">
