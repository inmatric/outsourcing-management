...
@section('content')
    <div class="p-6 bg-white rounded-lg shadow">
        ...
        <form action="{{ route('permissions-request.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="gap-6 mb-6 py-4">
                ...
                <div class="mb-4">
                    ...
                    <select id="izin_type" name="izin_type"
                        ...
                        <option selected hidden>Pilih Jenis Izin</option>
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="attachment">Upload
                        file</label>
                    <input
            ...
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Ajukan</button>
        </form>
    </div>
@endsection
