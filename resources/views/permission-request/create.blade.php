...
@section('content')
    <div class="p-6 bg-white rounded-lg shadow">
        <h2 class="text-2xl font-semibold mb-4">Apply for Permission</h2></h2>
        <form action="{{ route('permission-request.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="gap-6 mb-6 py-4">
                ...
                <div class="mb-4">
                    <label for="izin_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Permission Type</label>
                    <select id="izin_type" name="izin_type"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected hidden>Select Permission Type</option>
