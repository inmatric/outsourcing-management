...
@section('title', 'Work Equipment - Create') {{-- Mengubah title --}}
@section('content')
<div class="max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
    ...
    <form action="{{ route('workequipment.store') }}" method="POST" class="space-y-6">
        ...
        {{-- Job Name --}}
        <div>
            <label for="work_id" class="block text-sm font-medium text-gray-700">Position</label>
