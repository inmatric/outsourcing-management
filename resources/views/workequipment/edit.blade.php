        ...
        <form action="{{ route('workequipment.update', $workequipment->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="employee_id" id="employee_id"
                    ...
                    value="{{ old('employee_id', $workequipment->employee_id) }}" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="employee_name" id="employee_name"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                          focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    value="{{ old('employee_name', $workequipment->employee_name) }}" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="position" id="position"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                          focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    value="{{ old('position', $workequipment->position) }}" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="location" id="location"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                          focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    value="{{ old('location', $workequipment->location) }}" required>
            </div>
