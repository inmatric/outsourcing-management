...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('complaint_resolution.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="pt-4 flex items-center space-x-3">
                <a href="{{ url('/complaint_resolutions') }}"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            complaintSelect.addEventListener("change", function() {
                ...
                if (complaintId) {
                    fetch(`/get-complaint-detail/${complaintId}`)
